          ...
          <v-card-text>
            <v-container>
              <form @submit.prevent="onSignup">
                ...
                <v-layout row>
                  <v-flex xs12>
                    <v-text-field :rules="[comparePasswords]" name="confirmPassword" label="Confirm Password" id="confirmPassword" v-model="confirmPassword" type="confirmPassword" ></v-text-field>
                  </v-flex>
                </v-layout>
                <v-layout row>
                  <v-flex xs12>
